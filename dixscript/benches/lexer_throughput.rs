...
fn comprehensive_lexer_benchmark(c: &mut Criterion) {
    ...
    // ------------------------------------------------------------------
    // Test 1: Real .dixscript file
    // ------------------------------------------------------------------
    let real_file = std::fs::read_to_string("../../mdix_files/advanced/all_datatypes_test.dixscript")
        .expect("Failed to read all_datatypes_test.dixscript");
