...
// mdix-lsp/src/features/hover.rs — add near STATIC_SIGS at bottom of file

/// Typed signatures for builtin instance methods.
/// (type_name, method_name, params_with_types, return_type, example)
static INSTANCE_METHOD_SIGS: &[(&str, &str, &str, &str, &str)] = &[
    // ── String ──────────────────────────────────────────────────────────────
    ...
    ("object", "merge",       "other: object",                        "object", "obj1.merge(obj2) // other overrides on clash"),
    // ── Blob ─────────────────────────────────────────────────────────────────
    ...
    ("blob", "toBytes",       "",                                     "array",  "myBlob.toBytes() // array of ints 0-255"),
