...
MdixBuilder, 
// ── Database ────────────────────────────────────────────────────────────
MdixDatabase, prefetchImport, 
// ── DLM (compress / encrypt / audit) ───────────────────────────────────
compileWithDlm, decompileWithDlm, MdixDlmOutcome, 
// ── Merge ───────────────────────────────────────────────────────────────
mergeSources, mergeSourcesWeighted, MdixMergeOutcome, 
// ── Schema validation ───────────────────────────────────────────────────
MdixSchema, MdixValidationReport, 
// ── Hot reload / watch ──────────────────────────────────────────────────
MdixWatcher, MdixWatchOutcome, } from "../wasm-pkg-node/mdix_wasm.js";
